<x-music-layout>
    ...
    <style>
        ...
        .song-play-overlay {
            ...
            pointer-events: none; /* RẤT QUAN TRỌNG: Giúp click không bị chặn */
        }
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-5">
                <div class="artist-sidebar-card">
                    ...
                    @endphp
                    <img src="{{ asset($artistSource ? 'images/' . $artistSource : 'images/' . $artistDefault) }}" class="artist-avatar-circle" alt="{{ $artist->artist_name }}">
