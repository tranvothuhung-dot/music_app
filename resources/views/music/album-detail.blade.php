<x-music-layout>
    ...
    <style>
        ...
        .album-cover-circle {
            width: 220px;
            height: 220px;
            border-radius: 50%; /* Bo tròn hoàn toàn hình ảnh */
            object-fit: cover;
        ...
        .album-artist {
            color: #0d6efd; /* Màu xanh giống hình mẫu */
            font-weight: 700;
            font-size: 16px;
            margin-bottom: 12px;
        }
    ...
    <div class="container py-4 container-album">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-5">
                <div class="album-sidebar-card">
                     @php
                        $albumIndex = ($album->album_id ?? $album->id ?? 1) % 8;
                        $albumIndex = $albumIndex === 0 ? 8 : $albumIndex;
            ...
            <div class="col-lg-8 col-md-7">
                ...
                @if($songs->count() > 0)
                    ...
                    @endforeach
                @else
                    <div class="alert alert-info border-0 shadow-sm rounded-3">Album này chưa có bài hát nào.</div>
                @endif
            </div>
